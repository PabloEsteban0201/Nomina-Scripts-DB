...
CREATE TABLE companies (
    ...
    country_code_fk NUMBER(3) NOT NULL
);
...
CREATE TABLE countries (
    ...
    iso_abrreviation VARCHAR2(5) NOT NULL,
    name_country     VARCHAR2(20) NOT NULL,
    code_curr_fk     NUMBER NOT NULL
);
...
CREATE TABLE employees (
    ...
    personal_number NUMBER(12) NOT NULL,
    name_person     VARCHAR2(20) NOT NULL,
    lastname        VARCHAR2(25) NOT NULL,
    salary          NUMBER(9) NOT NULL,
    email           VARCHAR2(50) NOT NULL,
    state           NUMBER NOT NULL,
    charge_fk       NUMBER NOT NULL,
...
CREATE TABLE payments (
    ...
    type_period_fk  NUMBER,
    employee_fk     NUMBER NOT NULL
);
...
ALTER TABLE paymentconcepts
    ADD CONSTRAINT concepts_payments_fk FOREIGN KEY ( payment_fk )
        REFERENCES payments ( payment_id );

ALTER TABLE countries
    ADD CONSTRAINT countries_currency_fk FOREIGN KEY ( code_curr_fk )
...
ALTER TABLE employees
    ADD CONSTRAINT employees_companies_fk FOREIGN KEY ( company_fk )
        REFERENCES companies ( company_id );

ALTER TABLE payments
    ADD CONSTRAINT payments_employees_fk FOREIGN KEY ( employee_fk )
        REFERENCES employees ( employee_id );

ALTER TABLE payments
    ADD CONSTRAINT payments_type_period_fk FOREIGN KEY ( type_period_fk )
        REFERENCES type_period ( period_id );

ALTER TABLE paymentconcepts
    ADD CONSTRAINT typeconcepts_fk FOREIGN KEY ( type_concept_fk )
