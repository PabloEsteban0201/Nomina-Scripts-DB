...
CREATE TABLE companies (
    ...
    country_code_fk VARCHAR2(4) NOT NULL
);

ALTER TABLE companies ADD CONSTRAINT companies_pk PRIMARY KEY ( company_id );

CREATE TABLE companycharges (
    company_id_fk NUMBER NOT NULL,
    charge_id_fk  NUMBER(20) NOT NULL
);

ALTER TABLE companycharges ADD CONSTRAINT companycharges_pk PRIMARY KEY ( company_id_fk,
                                                                          charge_id_fk );

CREATE TABLE countries (
    code_id     VARCHAR2(4) NOT NULL,
    name        VARCHAR2(50) NOT NULL,
    currency_fk NUMBER NOT NULL
);
...
CREATE TABLE employees (
    ...
    charge_fk   NUMBER(20) NOT NULL
);

ALTER TABLE employees ADD CONSTRAINT employees_pk PRIMARY KEY ( personal_id );

CREATE TABLE paymentconcepts (
    concept_id      NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
    amount          NUMBER(10) NOT NULL,
    type_concept_fk NUMBER NOT NULL,
    payment_fk      NUMBER NOT NULL
);
...
CREATE TABLE payments (
    ...
    total_benefits  NUMBER(9),
    total_retentios NUMBER(9),
    total_licenses  NUMBER(9),
    total_taxes     NUMBER(9),
    total           NUMBER(9),
    period          NUMBER,
    personal_id_fk  NUMBER(12) NOT NULL,
    period_id_fk    NUMBER NOT NULL
);
...
ALTER TABLE UserManager ADD CONSTRAINT user_pk PRIMARY KEY ( user_id );

ALTER TABLE companies
    ADD CONSTRAINT companies_countries_fk FOREIGN KEY ( country_code_fk )
        REFERENCES countries ( code_id );

ALTER TABLE companycharges
    ADD CONSTRAINT companycharges_charges_fk FOREIGN KEY ( charge_id_fk )
        REFERENCES charges ( charge_id );

ALTER TABLE companycharges
    ADD CONSTRAINT companycharges_companies_fk FOREIGN KEY ( company_id_fk )
        REFERENCES companies ( company_id );

ALTER TABLE countries
    ADD CONSTRAINT countries_currency_fk FOREIGN KEY ( currency_fk )
        REFERENCES currency ( code_curr_id );

ALTER TABLE employees
    ADD CONSTRAINT employees_charges_fk FOREIGN KEY ( charge_fk )
        REFERENCES charges ( charge_id );

ALTER TABLE paymentconcepts
    ADD CONSTRAINT paymentconcepts_fk FOREIGN KEY ( payment_fk )
...
ALTER TABLE payments
    ADD CONSTRAINT payments_type_period_fk FOREIGN KEY ( period_id_fk )
        REFERENCES type_period ( period_id );

ALTER TABLE paymentconcepts
    ADD CONSTRAINT paymenttypeconcept_fk FOREIGN KEY ( type_concept_fk )
